...
import {CompleteRegistrationComponent} from "./views/pages/complete-registration/complete-registration.component";

const routes: Routes = [
  {
    path: 'dashboard',
    loadChildren: () => import('../app/views/dashboard/dashboard-routing.module').then(m => m.DashboardRoutingModule)},
